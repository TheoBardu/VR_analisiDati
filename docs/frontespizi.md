...
```
/Users/theo/Desktop/P.IVA/Aziende/Ermes/Modelli/docx/frontespizi/
```
...
1. **Immagine incorporata nel `.docx`** — si incolla il logo direttamente nel file del
   frontespizio in Word. È l'approccio usato da `frontespizio_Relyon.docx`. Consigliato
...
- **Niente contenuto in intestazione e piè di pagina.** Vengono scartati: quelli del
  documento finale arrivano dal template principale.
...
> minuscole, quindi `frontespizio_relyon.docx` funziona anche se il file si chiama
> `frontespizio_Relyon.docx`. Su altri sistemi no: conviene scrivere il nome esatto.
...
f = '/Users/theo/Desktop/P.IVA/Aziende/Ermes/Modelli/docx/frontespizi/frontespizio_Relyon.docx'
